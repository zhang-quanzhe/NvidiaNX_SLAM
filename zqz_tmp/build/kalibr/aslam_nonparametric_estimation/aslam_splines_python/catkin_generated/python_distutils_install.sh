...
echo_and_run cd "/home/nvidia/zqz_tmp/src/kalibr/aslam_nonparametric_estimation/aslam_splines_python"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/nvidia/zqz_tmp/src/kalibr/aslam_nonparametric_estimation/aslam_splines_python/setup.py" \
     \
    build --build-base "/home/nvidia/zqz_tmp/build/kalibr/aslam_nonparametric_estimation/aslam_splines_python" \
    install \
    --root="${DESTDIR-/}" \
