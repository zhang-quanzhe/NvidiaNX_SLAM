...
echo_and_run cd "/home/nvidia/zqz_tmp/src/kalibr/Schweizer-Messer/sm_python"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/nvidia/zqz_tmp/src/kalibr/Schweizer-Messer/sm_python/setup.py" \
     \
    build --build-base "/home/nvidia/zqz_tmp/build/kalibr/Schweizer-Messer/sm_python" \
    install \
    --root="${DESTDIR-/}" \
