...
echo_and_run cd "/home/nvidia/zqz_tmp/src/kalibr/aslam_cv/aslam_cv_python"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/nvidia/zqz_tmp/src/kalibr/aslam_cv/aslam_cv_python/setup.py" \
     \
    build --build-base "/home/nvidia/zqz_tmp/build/kalibr/aslam_cv/aslam_cv_python" \
    install \
    --root="${DESTDIR-/}" \
