...
echo_and_run cd "/home/nvidia/zqz_tmp/src/kalibr/aslam_cv/aslam_cameras_april"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/nvidia/zqz_tmp/src/kalibr/aslam_cv/aslam_cameras_april/setup.py" \
     \
    build --build-base "/home/nvidia/zqz_tmp/build/kalibr/aslam_cv/aslam_cameras_april" \
    install \
    --root="${DESTDIR-/}" \
