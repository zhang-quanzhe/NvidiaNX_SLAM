...
echo_and_run cd "/home/nvidia/zqz_tmp/src/kalibr/aslam_optimizer/aslam_backend_python"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/nvidia/zqz_tmp/src/kalibr/aslam_optimizer/aslam_backend_python/setup.py" \
     \
    build --build-base "/home/nvidia/zqz_tmp/build/kalibr/aslam_optimizer/aslam_backend_python" \
    install \
    --root="${DESTDIR-/}" \
