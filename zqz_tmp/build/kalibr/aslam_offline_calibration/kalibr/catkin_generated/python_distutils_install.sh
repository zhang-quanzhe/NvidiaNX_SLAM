...
echo_and_run cd "/home/nvidia/zqz_tmp/src/kalibr/aslam_offline_calibration/kalibr"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/nvidia/zqz_tmp/src/kalibr/aslam_offline_calibration/kalibr/setup.py" \
     \
    build --build-base "/home/nvidia/zqz_tmp/build/kalibr/aslam_offline_calibration/kalibr" \
    install \
    --root="${DESTDIR-/}" \
